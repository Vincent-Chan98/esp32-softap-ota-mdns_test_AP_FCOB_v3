    ...
    while(1){
        ...
        if (err_tx == ESP_OK && rx_message.extd==1)//                                                                                                                         ABC         
        {
            ...
            {       
                ...
                {
                case 0x0:   data7 = rx_message.data[7];break;   // no signal
                case 0x1:   data7 = rx_message.data[7];break;   // open
                case 0x2:   data7 = rx_message.data[7];break;   // close          
                default:    break;
                }                                                
            }
        } else{can_flag = false;}        
...
void fcob()
{
    while (1)
    {
        switch (data7)
		{
		case 0x0:            clear_all_fcob();break;
        case 0x1:            do{midopn();}while(data7!=0x2); break;
        case 0x2:            clsmid();break;        
        default:break;
		}
        vTaskDelay(1/portTICK_PERIOD_MS);
    }
